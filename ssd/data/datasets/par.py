...
class PARDataset(torch.utils.data.Dataset):
    class_names = ('__background__',
                   'Abreast', 'BlackMetal1', 'BlackMetal2', 'BlackMetal4')
    ...
    def __init__(self, data_dir, split, transform=None, target_transform=None, keep_difficult=False):
        ...
        """
        self.data_dir = r'D:\Python\Python Project\SSD-Resnet-Attention-FeatureFusion-copy\ssd\data\datasets\particles'
        self.split = split
        self.transform = transform
        self.target_transform = target_transform
        image_sets_file = os.path.join(self.data_dir, "ImageSets", "Main", "%s.txt" % self.split)
        self.ids = PARDataset._read_image_ids(image_sets_file)
